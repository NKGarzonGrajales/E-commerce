...
const mockProducts: IProduct[] = [
  ...
  },
  {
    ...
    price: 113,
    description:
      "Gaming Monitor 144Hz/165Hz, FHD(1920x1080P) 100% sRGB Computer Monitor, Height/Pivot/Swivel/Tilt Adjustable Vertical Monitor, Support FreeSync, DP, HDMI, Wall Mount (75mmX75mm)",
    image:
      "https://m.media-amazon.com/images/I/71+ygySG+TL._AC_SL1500_.jpg",
    categoryId: 6,
    stock: 10,
  },
] 
